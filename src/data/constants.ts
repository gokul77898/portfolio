...
export const EXPERIENCE: Experience[] = [
  {
    ...
    endDate: "Present",
    title: "AI Engineer",
    company: "Omilos Solutions",
    description: [
      "Design and deploy LLM-based applications including RAG systems and fine-tuned SLM/LLM models.",
      "Architect backend inference pipelines integrating vector databases, model APIs, and business logic.",
      "Build full-stack AI applications (Next.js + FastAPI/Node) from prototype to production.",
      "Implement modular inference services with environment-isolated configuration and scalable deployment.",
      "Collaborate directly with leadership on system design, model optimization, and infrastructure decisions.",
    ],
    skills: [
      SkillNames.NODEJS,
      SkillNames.DOCKER,
