...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "Gokul.venkatareddy@gmail.com",
    href: "mailto:Gokul.venkatareddy@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/gokul-v-0a1a89310",
    content: "/gokul-v-0a1a89310",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/gokul77898",
    content: "/gokul77898",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Gokul Venkatareddy</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Gokul, an AI Engineer focused on large language
              model systems, distributed inference architecture, and applied
              machine learning research. I build production-grade LLM pipelines,
              retrieval-augmented systems, and full-stack AI applications.
            </p>
            <p className="mb-10">
              When I&apos;m not building AI systems, you can find me exploring
              new ML research papers, experimenting with model architectures, or
